...
| La gestión de portafolios, autenticación, permisos, estados de ciclo de vida, historial de reportes, recuperación de elementos eliminados, dependencias, calendarios, recursos, líneas base, facturación y cronogramas detallados está fuera de alcance. | §2; §10 | El producto no busca gestionar esas capacidades. | Habría que ampliar el alcance para gestionarlas. | — |
