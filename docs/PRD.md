...
| RF-05 | [E] Entregar la interpretación de CPI y SPI junto con su valor. [S] Aplicar la banda neutral. | [E] Dado CPI 0,87 y SPI 1,02, entonces se muestran «sobre presupuesto» y «adelantado». [S] Dados ambos en 0,997, entonces se muestran «en presupuesto» y «en cronograma». [S] Dado CPI 0,98912, se muestra `<0,99`, «sobre presupuesto» y estado desfavorable; dado SPI 0,98912, se muestra `<0,99`, «atrasado» y estado desfavorable. [S] Dado CPI 1,01088, se muestra `>1,01`, «eficiente en costos» y estado favorable; dado SPI 1,01088, se muestra `>1,01`, «adelantado» y estado favorable. [D] Un indicador no evaluable se reporta como tal, no como error. |
