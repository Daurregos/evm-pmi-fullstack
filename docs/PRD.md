...
| RF-05 | [E] Entregar la interpretación de CPI y SPI junto con su valor. [S] Aplicar la banda neutral. | [E] Dado CPI 0,87 y SPI 1,02, entonces se muestran «sobre presupuesto» y «adelantado». [S] Dados ambos en 0,997, entonces se muestran «en presupuesto» y «en cronograma». [D] Un indicador no evaluable se reporta como tal, no como error. |
...
[D] Los cálculos encadenados conservan la precisión sin redondear. [S] Los montos y los índices se presentan con dos decimales, redondeando al más cercano. [S] El avance se presenta como porcentaje entero. [S] La banda neutral y el estado visual se aplican al índice ya redondeado, para coincidir con el valor mostrado.
...
| [S] La interpretación se aplica después de redondear el índice mostrado. | [S] Mantiene consistentes el número y su estado visual. | [S] En los límites, el número y el estado podrían discrepar. |
