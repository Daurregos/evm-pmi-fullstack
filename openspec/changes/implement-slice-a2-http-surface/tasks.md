...
- [ ] 1.1 Extend the contract runner so one Next.js process exercises both the retained mock suite and serial real-route tests against migrated PostgreSQL.
...
- [ ] 5.1 Contrast every verification statement in ADR-006a, ADR-006b, ADR-007 and ADR-009 with a named automated test, adding coverage where evidence is missing.
